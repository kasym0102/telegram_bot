...
@Component
public class ScienceHandler implements InputMessageHandler {
    private ReplyMessagesService messagesService;

    public ScienceHandler(ReplyMessagesService messagesService) {
...
//        return new SendMessage(message.getChatId(),"Перейди на наш канал", new InlineKeyboardButton("Канал Ассоциаций"));
    ...
    private SendMessage processUsersInput(Message inputMsg) {
        ...
        SendMessage replyToUser = messagesService.getReplyMessage(chatId, "reply.Science");
    ...
    private InlineKeyboardMarkup getInlineMessageButtons() {
        ...
        InlineKeyboardButton buttonYes = new InlineKeyboardButton().setText("Наука и Бизнес").setUrl("http://globaljournals.ru/nauka-i-biznes/");
